...
#python test.py --host "refract.cqkkwwmb5gtj.us-east-1.rds.amazonaws.com" --database "ai_logistics" --user "postgres" --password "R_PgcoL5yVz2r7_T" --options "-c search_path=ai_logistics"